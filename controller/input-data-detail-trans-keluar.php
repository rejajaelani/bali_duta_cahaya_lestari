...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    while (!isIDUnique($conn, 'tb_detail_trans_keluar', 'id', $newID)) {
        $newID = generateUniqueID();
    }

    $sql = "INSERT INTO tb_detail_trans_keluar (id, id_transaksi_keluar, id_akun, debet, kredit, update_at) VALUES('$newID', '$id_transaksi', '$id_akun', $debet, $kredit, '$tgl_now')";
