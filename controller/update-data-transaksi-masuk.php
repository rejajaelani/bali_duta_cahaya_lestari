...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE tb_transaksi_masuk SET tgl_trans_masuk = '$tgl', keterangan = '$keterangan', type_transaksi = $type_transaksi, update_at = '$tgl_now' WHERE id_transaksi_masuk = '$id_transaksi'";
