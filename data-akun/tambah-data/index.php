                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="../../controller/input-data-akun.php" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="level" id="level" value="2">
                                        <div class="form-group">
                                            <label for="kode-akun">Kode Akun</label>
                                            <input type="text" class="form-control" id="kode-akun" name="kode-akun" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="kategori-akun" name="kategori-akun" required>
                                                ...
                                                ?>
                                                    <option value="<?= $item['id_kategori_akun'] ?>"><?= $item['nama_kategori'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
