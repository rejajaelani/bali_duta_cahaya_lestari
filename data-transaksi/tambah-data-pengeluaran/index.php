                                ...
                                <div class="card-body">
                                    ...
                                    <form id="simpanForm" action="../../controller/input-data-transaksi-keluar.php" method="post" class="mb-2 mt-4">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control" id="id-keterangan" name="id-keterangan" required>
                                                    <option style="display: none;"></option>
                                                    <?php
                                                    $sql = "SELECT * FROM tb_keterangan WHERE type_transaksi = 2";
                                                    $result = mysqli_query($conn, $sql);
                                                    while ($row = mysqli_fetch_assoc($result)) { ?>
                                        ...
                                        <div class="w-100 d-flex justify-content-end mb-4">
                                            <a href="../../controller/discard-transaksi.php?id=<?= $id_transaksi ?>&type=2" class="btn btn-danger btn-sm mr-2">Discard Transaksi</a>
