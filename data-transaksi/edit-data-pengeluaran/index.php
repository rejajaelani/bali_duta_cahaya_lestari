...
$sql0 = "SELECT * FROM tb_detail_trans_keluar tdtk INNER JOIN tb_akun ta ON tdtk.`id_akun` = ta.`id_akun` WHERE tdtk.`id_transaksi_keluar` = '$id' ORDER BY tdtk.`created_at` DESC";
$result0 = mysqli_query($conn, $sql0);

$sql1 = "SELECT * FROM tb_transaksi_keluar tbtm WHERE tbtm.id_transaksi_keluar = '$id_transaksi'";
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6 col-lg-12">
                            <h1 class="m-0">Edit Data Transaksi keluar</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6 col-lg-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">Data Master</li>
                                <li class="breadcrumb-item"><a href="../">Data Transaksi keluar</a></li>
                                <li class="breadcrumb-item active">Edit Data Transaksi keluar</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <form id="simpanForm" action="../../controller/update-data-transaksi-keluar.php" method="post" class="mb-2 mt-4">
                                        ...
                                        ?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" id="id-transaksi" name="id-transaksi" value="<?= $row['id_transaksi_keluar'] ?>" readonly required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="date" class="col-sm-2 col-form-label">Tanggal</label>
                                                    <div class="col-sm-10">
                                                        <input type="date" class="form-control" id="date" name="date" value="<?= $row['tgl_trans_keluar'] ?>" onchange="setTanggalCache()" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
